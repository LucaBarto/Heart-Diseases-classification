...
```{r Change target variable to factor}
...
```{r Set up grid for Adaptive Boosting}
# Set up tuning grid
...
```{r Prediction with Adaptive Boosting}
# Predict data
set.seed(1, sample.kind="Rounding")
...
```{r ROC curve for Adaptive Boosting}
# Define ROC Curve
...
```{r Set up grid for Stochastic Gradient Boosting}
# Set up tuning grid
...
```{r Prediction with Stochastic Gradient Boosting}
# Predict data
set.seed(1, sample.kind="Rounding")
...
```{r ROC curve for Stochastic Gradient Boosting}
# Define ROC Curve
...
```{r Set up grid for Classification Trees}
# Set up tuning grid
...
```{r Prediction with Classification Trees}
# Predict data
set.seed(1, sample.kind="Rounding")
...
```{r ROC curve for Classification Trees}
# Define ROC Curve
...
```{r Set up grid for Random Forest}
# Set up tuning grid
...
```{r Set up grid for K Nearest Neighbor}
# Set up tuning grid
...
```{r Prediction with K Nearest Neighbor}
# Predict data
set.seed(1, sample.kind="Rounding")
...
```{r ROC curve for K Nearest Neighbor}
# Define ROC Curve
...
```{r Set up grid for Neural Network}
# Set up tuning grid
...
```{r ROC curve for Neural Network}
# Define ROC Curve
